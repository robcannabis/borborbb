...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1213355430622003281/1213356086103642122/5132x.gif?ex=65f52ce9&is=65e2b7e9&hm=c8f793f02ef12ed0de510e8bf5112f417b722551a8646b2555e4b5ef3c951298&']; //รูปใหญ่
    ...
    const ddds = ['https://www.youtube.com/watch?v=Mk74XNKPOPs']; // ลิ้ง button1

   const iooi = ['INSTAGRAM ꒰♡꒱']; // ชื่อ button 2
   const iiio = ['https://www.instagram.com/fridaymars__']; // ลิ้ง button 2
...
change[Math.floor(Math.random()*change.length)]; // รูปใหญ่
    ...
    const r = new Discord.RichPresence()
      ...
      .setState(`𓂃𐐪 No answer ⚬ plz wait 𐑂𓂃`)
      .setName(`RobShop`)
      .setDetails(`𓊆 borbor 𓊇 19:03 ◞✿`)
